...
public class RsvInfo {
    ...
    private int d; //예약 승인 혹은 거절에 대한 여부
    ...
    public int getDecision(){return d;}
    public void setDecision(int d){this.d=d;}

    public void printRsvList(){
        System.out.println(Rsv_Num+" "+Room_Num+" "+iTime+" "+oTime+" "+checkIn_date+" "+checkOut_date+" "+NumOfPeople+" "+d);
    }
}
